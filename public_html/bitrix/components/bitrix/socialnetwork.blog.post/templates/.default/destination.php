...
<div class="feed-add-post-destination-block feed-add-post-destination-block-post" id="destination-sharing" style="display:none;">
	...
	<div class="feed-add-post-buttons-post">
		<a class="feed-add-button" href="javascript:void(0)" onmousedown="BX.addClass(this, 'feed-add-button-press')" onmouseup="BX.removeClass(this,'feed-add-button-press')" onclick="sharingPost()"><?
			?><span class="feed-add-button-left"></span><?
			?><span class="feed-add-button-text"><?=GetMessage("BLOG_SHARE_ADD")?></span><?
