;(function(window){
	...
	window.ViewEventManager.prototype = {
		...
		InitPopups: function()
		{
			...
			{
				this.popupNotifyMoreY = new BX.PopupWindow('bx_event_attendees_window_y_' + this.id + '_' + rand, this.pMoreAttLinkY,
					{
						zIndex: 200,
						lightShadow : true,
						offsetTop: -2,
			...
			{
				this.popupNotifyMoreN = new BX.PopupWindow('bx_event_attendees_window_n_' + this.id + '_' + rand, this.pMoreAttLinkN,
					{
						zIndex: 200,
						lightShadow : true,
						offsetTop: -2,
		...
		ShowUserStatus: function(status)
		{
			...
			if (status)
			{
				...
				if (status == 'Y')
				{
					...
					this.popupAccepted = new BX.PopupWindow('bx_event_change_win_y_' + this.id + '_' + rand, linkY, {
						zIndex: 200,
						lightShadow : true,
						offsetTop: -5,
				...
				else if (status == 'N')
				{
					...
					this.popupDeclined = new BX.PopupWindow('bx_event_change_win_n_' + this.id + '_' + rand, linkN, {
						zIndex: 200,
						lightShadow : true,
						offsetTop: -5,
