...
$arEditParams = array("ALLOW_HTML", "ALLOW_ANCHOR", "ALLOW_BIU", "ALLOW_IMG",
	...
	"ALLOW_SMILES", "ALLOW_NL2BR", "ALLOW_TABLE", "ALLOW_MENTION");
				...
				while ($res = $db_res->GetNext())
				{
					...
					$res["URL"] = array(
						"LINK" => $APPLICATION->GetCurPageParam("MID=".$res["ID"],
							array("MID", "sessid", "AJAX_POST", "ENTITY_XML_ID", "ENTITY_TYPE", "ENTITY_ID", "REVIEW_ACTION"))
					);
