...
<table width="100%" style="font-weight: bold">
	<tr>
		...
		<td><? if (CSalePaySystemAction::GetParamValue("BUYER_ID")) {
		echo sprintf(
			'Kunden-Nr.: %s',
			CSalePaySystemAction::GetParamValue("BUYER_ID")
		); } ?></td>
...
if ($arBasket = $dbBasket->Fetch())
{
	...
	do
	{
		...
		if ($productName == "OrderDelivery")
			$productName = htmlspecialcharsbx("Schifffahrt");
		else if ($productName == "OrderDiscount")
			$productName = htmlspecialcharsbx("Rabatt");
