...
if (isset($_REQUEST["https_check"]) && $_REQUEST["https_check"] == "Y" && check_bitrix_sessid())
{
	...
	if (!@$ob->Get("https://".$_SERVER["SERVER_NAME"]."/bitrix/tools/sale_ps_result.php"))
	{
		$res = "error";
...
$aTabs = array(
		...
		array("DIV" => "edit3", "TAB" => GetMessage("SPS_DELIVERY_HANDLERS"), "ICON" => "sale", "TITLE" => GetMessage("SPS_DELIVERY_HANDLERS_DESC"))
	);
