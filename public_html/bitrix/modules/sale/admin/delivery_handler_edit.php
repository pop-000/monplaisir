...
{
	if ($arHandlersData = unserialize($_POST["STRUCTURE"]))
	{
...
<tr>
	...
	<td valign="top">
		<?=wrapDescrLHE(
			...
			'hndl_dscr');?>
		<!--<textarea name="HANDLER[DESCRIPTION]" cols="40" rows="5"><?=htmlspecialcharsbx($arDeliveryInfo[$SITE_ID]["DESCRIPTION"])?></textarea>-->
	...
	?>
		...
		<tr>
			...
			<?=wrapDescrLHE(
				...
				<!--<textarea name="HANDLER[PROFILES][<?=htmlspecialcharsbx($profileId)?>][DESCRIPTION]" cols="40" rows="5"><?=htmlspecialcharsbx($arProfile["DESCRIPTION"])?></textarea>-->
