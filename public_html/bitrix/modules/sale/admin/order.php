...
$lAdmin->sEpilogContent = "<script type=\"text/javascript\">if (document.getElementById('order_sum')) {setTimeout(function(){document.getElementById('order_sum').innerHTML = '".CUtil::JSEscape($order_sum)."';}, 10);}</script>";
