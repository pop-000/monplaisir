	...
	if (CLearnAccessMacroses::CanUserEditLesson(array('lesson_id' => $contextLessonId)))
	{
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/bitrix/admin/learn_question_edit.php?lang=" . LANGUAGE_ID
						. "&COURSE_ID=" . $arParams["COURSE_ID"]
						. "&LESSON_PATH=" . ( ($lessonID > 0) ? $lessonID : CCourse::CourseGetLinkedLesson ($arParams["COURSE_ID"]) ) 
		...
		$arMenuButtons[] = array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/bitrix/admin/learn_question_edit.php?lang=" . LANGUAGE_ID 
						. "&COURSE_ID=".$arParams["COURSE_ID"]."&LESSON_PATH=" . ( ($lessonID > 0) ? $lessonID : CCourse::CourseGetLinkedLesson ($arParams["COURSE_ID"]) ) 
