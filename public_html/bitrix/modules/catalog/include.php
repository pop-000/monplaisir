...
{
	static $boolNewCurrencyFormat = null;

	if (null === $boolNewCurrencyFormat)
		$boolNewCurrencyFormat = method_exists('CCurrencyLang', 'CurrencyFormat');
	return (
		$boolNewCurrencyFormat
		? CCurrencyLang::CurrencyFormat($fSum, $strCurrency, true)
		: CurrencyFormat($fSum, $strCurrency)
	);
}
...
function Add2Basket($PRICE_ID, $QUANTITY = 1, $arRewriteFields = array(), $arProductParams = array())
{
	...
	// add sku props
	$arParentSku = CCatalogSku::GetProductInfo($arProduct['ID']);
