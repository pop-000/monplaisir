...
include(GetLangFileName($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/modules/mail/lang/", "/admin/mail_mailservice_admin.php"));
...
if ($MOD_RIGHT == "W" && $arID = $lAdmin->GroupAction())
{
	...
	{
		$rsData = Bitrix\Mail\MailServicesTable::getList(array('filter' => array_filter($arFilter), 'order' => array($by => $order)));
