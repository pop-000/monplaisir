...
if(check_bitrix_sessid())
{
	...
	function addTableFileCell($intPropID, $arPropInfo)
	{
		...
		return CFile::InputFile("PROPERTY_DIRECTORY_VALUES[$intPropID][FILE]", 20, intval($arPropInfo["UF_FILE"]), false, 0, "IMAGE", "", 0, "class=typeinput", "", false, false);
	}
	...
	function addTableRow($intPropID, $arPropInfo)
	{
		return'<tr id="hlbl_property_tr_'.$intPropID.'">
					...
					<td>'.addTableNameCell($intPropID, $arPropInfo).addTableIdCell($intPropID, $arPropInfo).addTableDelField($intPropID, $arPropInfo).'</td>
