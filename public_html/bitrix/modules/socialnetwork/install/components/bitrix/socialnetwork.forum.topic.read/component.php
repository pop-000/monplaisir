...
$bNeedLoop = true; $checkProperties = null;
...
/************** Message info ***************************************/
	...
	if ($checkProperties == null || $checkProperties === true)
	{
		$res["PROPS"] = $GLOBALS["USER_FIELD_MANAGER"]->GetUserFields("FORUM_MESSAGE", $res["ID"], LANGUAGE_ID);
		$checkProperties = ($checkProperties === null ? !!$res["PROPS"] : $checkProperties );
	}
