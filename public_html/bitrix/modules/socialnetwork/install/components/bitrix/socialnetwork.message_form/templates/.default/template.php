...
else
{
	...
	{
		?>
		<form method="post" name="form1" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data" onmouseover="if(null != init_form){init_form(this)}" onkeydown="if(null != init_form){init_form(this)}" onsubmit="return ValidateForm(this);">
