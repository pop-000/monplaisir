					...
					)
					{
						foreach($arResult["PresetFiltersTop"] as $preset_filter_top_id => $arPresetFilter)
						{
							...
							?>{ 
								...
								href : "<?=CUtil::JSEscape($GLOBALS["APPLICATION"]->GetCurPageParam("preset_filter_top_id=".$preset_filter_top_id, array_merge($arResult["PageParamsToClear"], array("preset_filter_top_id"))))?>" 
							},
							<?
						}
						?>
