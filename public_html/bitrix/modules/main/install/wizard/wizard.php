...
define("SKIP_LAZY_LANGUAGE_LOAD", true);
	...
	function ShowStep()
	{
		...
		if ($dbType != "mssql" && $utf8)
		{
			...
			if ($funcOverload == "")
				...
				$funcOverload = $this->ShowResult($funcOverload, (intval($funcOverload) & 2) == 2);
...
class SelectWizardStep extends CWizardStep
{
	...
	function OnPostForm()
	{
		global $DB, $DBType, $DBHost, $DBLogin, $DBPassword, $DBName, $DBDebug, $DBDebugToFile, $APPLICATION, $USER, $MESS, $DBSQLServerType;
