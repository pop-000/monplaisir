...
final class FrameHelper
{
	...
	public function end()
	{
		...
		Frame::getInstance()->finishDynamicWithID($this->id, $this->staticPart === null? $this->dynamicPart: $this->staticPart, $this->containerId);
		$this->ended = true;
		return $this;
	}
	...
	public static function applyCachedData($cachedData)
	{
		...
		$frame->addDynamicData($cachedData["id"], $cachedData["dynamicPart"], $cachedData["staticPart"], $cachedData["containerId"]);
	}
}