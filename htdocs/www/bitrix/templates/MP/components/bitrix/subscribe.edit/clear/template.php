...
<div class="subscription">
		...
		<table cellspacing="0" class="subscription-layout">
			...
			<tr>
				...
				<td class="field-form">
					...
					<div class="subscription-buttons"><input type="submit" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("CT_BSE_BTN_EDIT_SUBSCRIPTION"): GetMessage("CT_BSE_BTN_ADD_SUBSCRIPTION"))?>" class="btn" /></div>
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="subscription-utility">
		...
		<input name="sf_EMAIL" type="text" class="subscription-textbox" value="<?echo GetMessage("CT_BSE_EMAIL")?>" onblur="if (this.value=='')this.value='<?echo GetMessage("CT_BSE_EMAIL")?>'" onclick="if (this.value=='<?echo GetMessage("CT_BSE_EMAIL")?>')this.value=''" /> <input type="submit" value="<?echo GetMessage("CT_BSE_BTN_SEND")?>" class="btn" />
	</div>
	</form>
	<?endif?>
