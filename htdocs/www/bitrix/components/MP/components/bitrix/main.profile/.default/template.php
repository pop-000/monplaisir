...
<table class="profile-table data-table">
	...
	?>
	<tr>
		<td><?=GetMessage('NAME')?><span class="starrequired">*</span></td>
		<td><input type="text" name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" required /></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="email" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" required /></td>
	</tr>
	<tr>
		<td><?=GetMessage('LOGIN')?><span class="starrequired">*</span></td>
		<td><input type="text" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" required /></td>
	</tr>
...
<p><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></p>
	...
	<p><input type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>" class="btn">&nbsp;&nbsp;<input type="reset" value="<?=GetMessage('MAIN_RESET');?>" class="btn"></p>
</form>
</div>